...
from util import City, read_cities, write_cities_and_return_them, generate_cities, path_cost, city_sizes
import sys
...
if __name__ == "__main__":
    ...
    min_cost = greedy.run(plot=True)
    print(f'Number of Cities: {sys.argv[1]}, Best Cost: {min_cost}\n')
    plt.show(block=True)
