...
import sys
import os
from util import City, read_cities, write_cities_and_return_them, generate_cities, visualize_tsp, path_cost, city_sizes
...
if __name__ == "__main__":
    ...
    sa = SimAnneal(cities, stopping_iter=12000)
    sa.run()
    print(f'Number of Cities: {sys.argv[1]}, Best Cost: {sa.best_fitness}\n')   
    sa.plot_learning()
    sa.visualize_routes()
