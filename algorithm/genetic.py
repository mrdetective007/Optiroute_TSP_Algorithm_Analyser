...
import math, sys
import random
from util import City, read_cities, write_cities_and_return_them, generate_cities, city_sizes
...
class GeneticAlgorithm:
    ...
    def selection(self):
        ...
        if self.roulette_selection:
            df = pd.DataFrame(self.ranked_population, columns=["index", "fitness"])
...
if __name__ == '__main__':
    ...
    print(f'Number of Cities: {sys.argv[1]}, Best Cost: {genetic_algorithm.best_distance()}\n')
